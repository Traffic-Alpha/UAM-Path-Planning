...
generate_route(
    ...
    output_trip=current_file_path('./ND_env/testflow.trip.xml'),
    output_turndef=current_file_path('./ND_env/testflow.turndefs.xml'),
    output_route=current_file_path('./ND_env/osm.rou.xml'),
